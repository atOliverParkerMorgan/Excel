...
public:
    Addition(AExpr lhs, AExpr rhs) : Expr(), m_Lhs(std::move(lhs)), m_Rhs(std::move(rhs)) {}
...
public:
    Multiplication(AExpr lhs, AExpr rhs) : Expr(), m_Lhs(std::move(lhs)), m_Rhs(std::move(rhs)) {}
...
public:
    Division(AExpr lhs, AExpr rhs) : Expr(), m_Lhs(std::move(lhs)), m_Rhs(std::move(rhs)) {}
...
public:
    Subtraction(AExpr lhs, AExpr rhs) : Expr(), m_Lhs(std::move(lhs)), m_Rhs(std::move(rhs)) {}
